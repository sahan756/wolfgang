...
if (isset($_POST['submit'])) {
    ...
    if ($found_user) {
        ...
        if (isset($_POST['element_9_1'])) {
            $photo->csadress1 = $_POST['cadress1'];
            $photo->csadress2 = $_POST['cadress2'];
            $photo->cscity = $_POST['ccity'];
            $photo->csprovince = $_POST['cprovince'];
            $photo->cspcode = $_POST['cpcode'];
            $photo->cscounty = $_POST['ccounty'];
        } else {
        ...
        if ($ccpassword == $photo->cpassword) {
            if ($photo->save()) {
                ...
                $session->message("Registration successful. {$photo->cfname} {$photo->clname}");
                redirect_to('registern.php');
            } else {
...
<script>
    $(function() {
        $("#element_9_1").click(function() {
            if ($(this).is(":checked")) {
                $("#li_8 input, #li_8 select").prop("disabled", true);
                //alert("checked");
            } else {
                $("#li_8 input, #li_8 select").prop("disabled", false);
            }
        });
    });
</script>
...
<div class="register_today">
    <h1 class="inner_head">NEW USERS - CREATE AN ACCOUNT</h1>
        ...
        <form id="form_808957" class="appnitro"  method="POST" action="">					
            <ul >
                ...
                <li class="section_break">
                    ...
                    <div>
                        <input id="element_5" name="cpassword" class="element text medium" type="password" maxlength="255" value=""/> 
                    </div> 
                </li>		<li id="li_6" >
                    <label class="description" for="element_6">Confirm password </label>
                    <div>
                        <input id="element_6" name="ccpassword" class="element text medium" type="password" maxlength="255" value=""/> 
                    </div> 
                </li>
...
<form class="formsec" method="POST">
    <div class="sign_in">
        ...
        <p class="info">Please sign in using your e-mail address and password</p><br/>
        ...
        <a href="forgetpass.php" class="forget">Forgot my Password</a>
    </div>
</form>
